...
elseif(RUNTIME_CHECK STREQUAL "asan" OR RUNTIME_CHECK STREQUAL "hwasan")
  ...
  if(RUNTIME_CHECK STREQUAL "asan")
    set(ASAN_VARIANTS "address,undefined,pointer-compare,pointer-subtract")
  elseif(RUNTIME_CHECK STREQUAL "hwasan")
    set(ASAN_VARIANTS "hwaddress,undefined,pointer-compare,pointer-subtract")
  ...
  set(SANITIZE_FLAGS "-g -fno-omit-frame-pointer -fsanitize=${ASAN_VARIANTS} -fsanitize-address-use-after-scope -DQD_MEMORY_DEBUG=1")
